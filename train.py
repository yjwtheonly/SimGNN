...
class Trainer(object):
    ...
    def prepare_for_train(self, random_id, hist, Dense_GCN, batch_size = 128, epoch_num = 10, val = 0.2):
        
		self.random_id = random_id
		self.hist = hist
		self.Dense_GCN = Dense_GCN
        ...
        self.model = SimGNN(self.labels, self.hist, self.Dense_GCN)
